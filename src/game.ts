...
export function mountGame(container: HTMLElement, options: GameOptions = {}): () => void {
  ...
  const introPages = [
    ...
    {
      title: 'THREE-LEVEL OPERATION',
      lines: [
        'Level 1: Rebuild the signal network.',
        'Collect SIGs, survive the suburbs,',
        'and earn Patrick\'s clearance key.',
        '',
        'Level 2: Pilot through the Static Fields.',
        'Use thrust, grab hats for invincibility,',
        'and reach the Clarity Beacon.',
        '',
        'Level 3: Face Count Crosstalk directly.',
        'Break the mech, expose the core,',
        'and end the Nightphase.',
      ],
    },
    {
      title: 'WIN CONDITION',
      lines: [
        'Complete all three levels to restore Acoustica.',
        'Every SIG you recover strengthens the network.',
        '',
        'Harmony is not brute force.',
        'It is signal, timing, and teamwork.',
        '',
        'Press SPACE/ENTER to begin the mission.',
      ],
    },
  ];
